...
public class BankLogic //implements ImplementorFunction 
{
	...
	public Map<Integer,CustomerDetails> readCustomer() throws CustomException
	{
		Map<Integer,CustomerDetails> tempMap=fileObj.readCustomerFile();
		cacheObj.addCustomer(tempMap);
		System.out.println("---------------This is in Logic Layer------------");
		System.out.println(tempMap);
		return tempMap;
	}
	public Map<Integer,Map<Integer,AccountDetails>> readAccount() throws CustomException
	{
		Map<Integer,Map<Integer,AccountDetails>> tempMap=fileObj.readAccountFile();
